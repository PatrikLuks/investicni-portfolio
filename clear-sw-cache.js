...
(async function aggressiveCacheClear() {
  console.log(
    '%c🧹 Starting AGGRESSIVE cache cleanup...',
  ...
  if (success && errors.length === 0) {
    ...
    console.log(
      '%c⚠️  CLEANUP COMPLETED WITH ERRORS',
      'color: #ffd43b; font-size: 18px; font-weight: bold;',
    );
    console.log('');
    ...
    console.log(
      ...
      'color: #339af0; font-size: 14px; font-weight: bold;',
    );
